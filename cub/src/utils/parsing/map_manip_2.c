...
/*   Updated: 2026/03/14 11:42:35 by tarandri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	find_player(t_map_data *data)
{
	...
	while (y < data->map_height)
	{
		...
		while (data->map[y][x])
		{
			...
			{
				data->player_x = (double)x;
				data->player_y = (double)y;
...
int	validate_map(t_map_data *data)
{
	...
	if (!flood_fill(map_copy, data->player_x, data->player_y, data->map_width,
			data->map_height))
	{
